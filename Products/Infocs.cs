...
public int GetCount()
{
 ...
 public IEnumerable<string> DropdownTitle(int skip, int take)
        {
            return appsContext.Products.Select(u => u.Title).Skip(skip).Take(take).ToList();
            throw new NotImplementedException();
        }

         public IEnumerable<string> DropdownTitle()
        {
            return appsContext.Products.Select(u => u.Title).ToList();
        
        }

        public void InsertAuthor(ProductController.BookInputModel bk)
        {
            throw new NotImplementedException();
        }
        ...
        {
            return appsContext.Report.ToList();
        }
        ...
        public void InsertProduct(Report newReport)
        {
            throw new NotImplementedException();
        }
